...
(define-struct log-cell (posn orientation sensors motors internal-values) #:mutable #:transparent)
...
(define objects (vector lever button rock battery-pack))
